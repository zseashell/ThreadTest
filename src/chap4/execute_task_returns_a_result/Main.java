package chap4.execute_task_returns_a_result;
...
public class Main {
	...
	public static void main(String[] args) {
		...
		for (int i = 0; i < 10; i++) {
			...
			FactorialCalculator caculator = new FactorialCalculator(number);
		...
		do {
			System.out.printf("Main: number of completed tasks is %d\n",
